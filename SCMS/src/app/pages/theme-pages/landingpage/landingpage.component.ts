  ...
  demos: demos[] = [
    {
      ...
      name: 'Main',
      url: 'https://mdash-angular-main.netlify.app//dashboards/dashboard1',
    },
    {
      id: 2,
      imgSrc: '/assets/images/landingpage/demos/demo-menubar.jpg',
      name: 'Stylish bar',
      url: 'https://mdash-angular-stylish.netlify.app/dashboards/dashboard1',
    },
    {
      id: 3,
      imgSrc: '/assets/images/landingpage/demos/demo-dark.jpg',
      name: 'Dark',
      url: 'https://mdash-angular-dark.netlify.app/dashboards/dashboard2',
    },
    {
      id: 4,
      imgSrc: '/assets/images/landingpage/demos/demo-authguard.jpg',
      name: 'Authguard',
      url: 'https://mdash-angular-authguard.netlify.app/authentication/login',
    },
    {
      id: 5,
      imgSrc: '/assets/images/landingpage/demos/demo-rtl.jpg',
      name: 'RTL',
      url: 'https://mdash-angular-rtl.netlify.app/dashboards/dashboard1',
    },
    {
      id: 6,
      imgSrc: '/assets/images/landingpage/demos/demo-horizontal.jpg',
      name: 'Horizontal',
      url: 'https://mdash-angular-horizontal.netlify.app/dashboards/dashboard2',
    },
  ];
  ...
  appdemos: demos[] = [
    {
      ...
      name: 'Calendar',
      url: 'https://mdash-angular-main.netlify.app//apps/calendar',
    },
    {
      id: 2,
      imgSrc: '/assets/images/landingpage/apps/app-chat.jpg',
      name: 'Chat',
      url: 'https://mdash-angular-main.netlify.app//apps/chat',
    },
    {
      id: 3,
      imgSrc: '/assets/images/landingpage/apps/app-contact.jpg',
      name: 'Contact',
      url: 'https://mdash-angular-main.netlify.app//apps/contacts',
    },
    {
      id: 4,
      imgSrc: '/assets/images/landingpage/apps/app-email.jpg',
      name: 'Email',
      url: 'https://mdash-angular-main.netlify.app//apps/email/inbox',
    },
    {
      id: 5,
      imgSrc: '/assets/images/landingpage/apps/app-courses.jpg',
      name: 'Courses',
      url: 'https://mdash-angular-main.netlify.app//apps/courses',
    },
    {
      id: 6,
      imgSrc: '/assets/images/landingpage/apps/app-employee.jpg',
      name: 'Employee',
      url: 'https://mdash-angular-main.netlify.app//apps/employee',
    },
    {
      id: 7,
      imgSrc: '/assets/images/landingpage/apps/app-note.jpg',
      name: 'Notes',
      url: 'https://mdash-angular-main.netlify.app//apps/notes',
    },
    {
      id: 8,
      imgSrc: '/assets/images/landingpage/apps/app-ticket.jpg',
      name: 'Tickets',
      url: 'https://mdash-angular-main.netlify.app//apps/tickets',
    },
    {
      id: 9,
      imgSrc: '/assets/images/landingpage/apps/app-invoice.jpg',
      name: 'Invoice',
      url: 'https://mdash-angular-main.netlify.app//apps/invoice',
    },
    {
      id: 10,
      imgSrc: '/assets/images/landingpage/apps/app-todo.jpg',
      name: 'Todo',
      url: 'https://mdash-angular-main.netlify.app//apps/todo',
    },
    {
      id: 11,
      imgSrc: '/assets/images/landingpage/apps/app-taskboard.jpg',
      name: 'Taskboard',
      url: 'https://mdash-angular-main.netlify.app//apps/taskboard',
    },
    {
      id: 12,
      imgSrc: '/assets/images/landingpage/apps/app-blog.jpg',
      name: 'Blog List',
      url: 'https://mdash-angular-main.netlify.app//apps/blog/post',
    },
  ];
  ...
  features: features[] = [
    {
      ...
      subtext:
        'MDash Admin comes with 6 pre-defined theme colors.',
    },
    {
      id: 2,
      icon: 'shield-lock',
    ...
    },
    {
      ...
      subtext:
        'The MDash Admin Pack includes nearly 50 UI components.',
    },
    {
      id: 5,
      icon: 'tag',
    ...
    },
    {
      ...
      subtext:
        'The MDash Admin package includes a wide variety of icon fonts.',
    },
    {
      id: 7,
