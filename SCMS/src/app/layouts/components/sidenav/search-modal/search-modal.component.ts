...
@Component({
  standalone: true,
  imports: [CommonModule, MatIconModule, MatButtonModule, MatRippleModule, TranslateModule],
  ...
  template: `
    <div>
        ...
        <div class="space-y-1">
          <div
            ...
            <div
              ...
              <div>{{ 'FOUND_IN_CONTACTS' | translate }}</div>
              <mat-icon
      ...
      <div class="p-4">
        <div class="text-xs font-semibold text-secondary px-2 mb-2">{{ 'SEARCH_PAGES' | translate }}</div>
      ...
      <div class="p-4">
        <div class="text-xs font-semibold text-secondary px-2 mb-2">{{ 'SEARCH_TASKS' | translate }}</div>
