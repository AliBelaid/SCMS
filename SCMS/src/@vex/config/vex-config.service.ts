...
export class VexConfigService {
  ...
  private departmentVisibleSubject = new BehaviorSubject<boolean>(false);
  departmentVisible$ = this.departmentVisibleSubject.asObservable();

 
 
  toggleDepartmentVisibility(): void {
    const currentState = this.departmentVisibleSubject.value;
    console.log(currentState)
    this.departmentVisibleSubject.next(!currentState);
  }
